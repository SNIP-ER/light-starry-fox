...
4. v1.1.2 *(исправление багов)*
 - Логотип снова отображается правильно
 - Убрана вертикальная полоса слева от закрепленных вкладок

3. v1.1.1
 - Закладки сделаны по центру
...
1. v1.0.0 (Название папки - chrome)
